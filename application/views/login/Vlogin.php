	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" action="<?= base_url('index.php/clogin/aksi_login/')?>" method="POST">
					...
					<div class="text-center m-t-10">
						<a class="txt2" href="<?= base_url("index.php/Cregister/")?>">
							Create your Account
							<i class="fa fa-long-arrow-right m-l-5" aria-hidden="true"></i>
						</a>
					</div>
					<div class="text-center m-b-100 m-t-10">
						<a class="txt2" href="<?= base_url("index.php/Clandingpage/")?>">
							Back to Home
							<i class="fa fa-long-arrow-right m-l-5" aria-hidden="true"></i>
						</a>
					</div>
